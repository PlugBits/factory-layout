...
export const templates: EquipmentTemplate[] = [
  ...
  { id: "office-desk", name: "事務机", category: "office", width: 1.4, depth: 0.7, height: 0.72, color: "#c4a882", icon: "机" },
  { id: "meeting-table", name: "会議テーブル", category: "office", width: 2.4, depth: 1.2, height: 0.72, color: "#b8956a", icon: "会" },
  { id: "office-shelf", name: "棚", category: "office", width: 0.9, depth: 0.4, height: 1.8, color: "#a07850", icon: "棚" },
  { id: "locker", name: "ロッカー", category: "office", width: 1.8, depth: 0.5, height: 1.8, color: "#7b8794", icon: "鍵" },
  { id: "printer", name: "印刷機", category: "office", width: 0.6, depth: 0.6, height: 1.1, color: "#475569", icon: "印" },
  { id: "whiteboard", name: "ホワイトボード", category: "office", width: 1.2, depth: 0.1, height: 1.2, color: "#e2e8f0", icon: "板" },
  { id: "sofa", name: "ソファ", category: "office", width: 1.8, depth: 0.8, height: 0.8, color: "#6b7280", icon: "SF" },
